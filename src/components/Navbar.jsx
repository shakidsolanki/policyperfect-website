        ...
        <div className="flex justify-between items-center h-20">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center gap-2 group">
              <ShieldCheck size={36} className="text-[#1e3a8a]" />
              <div className="flex flex-col">
                <span className="font-bold text-2xl tracking-tight text-[#1e3a8a] leading-none">
                  Policy Perfect
                </span>
                <span className="text-[10px] font-bold tracking-[0.2em] text-slate-800 uppercase mt-0.5">
                  Insurance
                </span>
              </div>
            </Link>
